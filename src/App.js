...
import { query } from "./api/querydata";
...
function App() {
  ...
  return (
    <>
      <div
        className="lg:mx-9 min-h-screen mx-auto flex flex-wrap md:flex-nowrap 
      ...
      >
        ...
        <div className="relative basis-10/12 lg:basis-2/3 xl:basis-6/12 flex flex-col">
          <textarea
            ...
            className="block w-11/12 p-2 m-2 text-sm text-black-900 border-2 
      outline-none border-gray-300 rounded focus:ring-blue-500 
      focus:border-blue-500 dark:border-gray-600 
      dark:placeholder-gray-400 dark:text-black-900 dark:focus:ring-blue-500 
      dark:focus:border-blue-500 text-center"
          ...
          <div className="flex justify-around mt-2">
            <button
              onClick={handleQuery}
              className="text-white w-32 bg-green-500 hover:bg-green-600 
    focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm 
    px-4 py-2 dark:bg-green-700 dark:hover:bg-green-800 dark:focus:ring-blue-800"
            >
              Fetch Image
            </button>
          ...
          <div className="mt-3 p-2 ">
            ...
            <textarea
              ...
              className={`mt-2 block w-full h-[5rem] p-1 text-sm text-gray-900 border-2 
    outline-none border-gray-300 bg-gray-50 focus:ring-blue-500 
    focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 
    dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 
    dark:focus:border-blue-500 flex items-center justify-center ${
      !isTextEnabled && "opacity-50 cursor-not-allowed"
    }`}
            ...
            <button
              className="mt-3 text-white w-32 bg-green-500 hover:bg-green-600 
