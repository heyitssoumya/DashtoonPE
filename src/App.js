...
function App() {
  ...
  <textarea
    ...
    className="block w-11/12 p-2 m-2 text-sm text-gray-900 border-2 
    outline-none border-gray-300 rounded focus:ring-blue-500 
    focus:border-blue-500 dark:border-gray-600 
    dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 
    dark:focus:border-blue-500 text-center" // Added text-center class
  ...
  />
            ...
            <div className='flex justify-around mt-2'>
                <button onClick={handleQuery}
                  className='text-white w-32 bg-green-700 hover:bg-blue-800 
  ...
  className={`mt-2 block w-2/4 h-[10rem] p-1 text-sm text-gray-900 border-2 
...
<textarea
  ...
  className={`mt-2 block w-full h-[5rem] p-1 text-sm text-gray-900 border-2 
    ...
    focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 
    dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 
    dark:focus:border-blue-500 flex items-center justify-center ${!isTextEnabled && 'opacity-50 cursor-not-allowed'}`}
  onChange={(e) => setTextValue(e.target.value)}
  disabled={!isTextEnabled}
/>
              ...
              <button
                className='mt-3 text-white w-32 bg-green-700 hover:bg-blue-800 
                focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm 
                px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800'
                onClick={handleText}
              >Enter Text
